...
public interface L2CAPConnection extends Connection {
    ...
    /**
     * Christian Lorenz: added for use in <code>RemoteDevice.getRemoteDevice(Connection)</code>.
     * Specifice to this implementation only.
     * @return The RemoteDevice associated with this L2CAPConnection.
     */
